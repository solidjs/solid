...
const m9: Accessor<number | undefined> = createMemo(
	(v?: number) => 123,
	undefined
);
...
const m14: Accessor<number> = createMemo(
	(v?: number): number => 123,
	undefined
);
...
const m22: Accessor<number> = createMemo(
	(v: number | string): number => 123,
	"asdf"
);
const m23: Accessor<number> = createMemo(
	(v?: number | string): number => 123,
	undefined
);
...
const ef = on(
	[one, two],
	([one, two], [prevOne, prevTwo], computed): number => {
...
const [stringOrFunc1, setStringOrFunc1] = createSignal<
	(() => number) | string
>("");
...
const [stringOrFunc2, setStringOrFunc2] = createSignal<
	(() => number) | string
>();
// @ts-expect-error number should not be assignable to string
setStringOrFunc2(() => 1);
...
const a2: Accessor<number | undefined> = createMemo<number | undefined>(() =>
	num()
);
...
const a21: Accessor<number | undefined> = createMemo<number | undefined>(
	(v?: number) => num()
);
...
const a3: Accessor<number | boolean> = createMemo<number | boolean>(() =>
	bool()
);
...
const a31: Accessor<number | boolean> = createMemo<number | boolean>(
	(v?: number) => num()
);
// @ts-expect-error this rare edge cases is not handled yet. The number return from the effect function should be assignable to number|boolean, while the initial value should be inferred as number|undefined.
...
const a4: Accessor<number | boolean> = createMemo<number | boolean>(() =>
	bool()
);
createEffect<number | boolean>(() => bool());
createComputed<number | boolean>(() => bool());
...
// FIXME
// @ts-expect-error this rare edge cases is not handled yet. The number return from the effect function should be assignable to number|boolean, while the initial value should be inferred as number|undefined.
const a41: Accessor<number | boolean> = createMemo<number | boolean>(
	(v?: number) => num()
);
// @ts-expect-error this rare edge cases is not handled yet. The number return from the effect function should be assignable to number|boolean, while the initial value should be inferred as number|undefined.
createEffect<number | boolean>((v?: number) => num());
...
const a5: Accessor<number | boolean> = createMemo<number | boolean>(
	() => bool(),
	false
);
