...
var _tmpl$8 = ["<section", "><!--$-->", "<!--/--><!--$-->", "<!--/--></section>"];
var _tmpl$9 = ["<section", "><!--$-->", "<!--/--><span>native</span></section>"];
      ...
      (() => {
        ...
        return () => {
          ...
          return _c$()
            ...
            : ((_v$41 = _$ssrHydrationKey()), _$ssr(_tmpl$10, _v$41));
        };
      })()
    ),
