...
describe('setState with reconcile', () => {
  ...
  test('Reconcile a simple object on a nested path', () => {
    var [state, setState] = createState({ data: {user: {firstName: 'John', lastName: 'Snow'} }});
  ...
  test('Reconcile overwrite in non-keyed merge mode', () => {
    ...
    setState(reconcile(['users', [{...NED}, {...JOHN}, {...BRANDON}]], {merge: true, key: null}));
