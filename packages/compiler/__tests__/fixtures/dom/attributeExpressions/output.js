...
_$effect(() => _$snapshot(someStyle()), (_v$, _$p) => {
...
const template33 = [
	(() => {
		var _el$45 = _tmpl$21();
		_$effect(() => _$snapshot(styles.button), (_v$, _$p) => {
	...
	(() => {
		var _el$46 = _tmpl$21();
		_$effect(() => _$snapshot(styles["foo--bar"]), (_v$, _$p) => {
	...
	(() => {
		var _el$48 = _tmpl$21();
		_$effect(() => _$snapshot(styles[foo()]), (_v$, _$p) => {
...
var _el$103 = _tmpl$4();
_$effect(() => _$snapshot(styleProp.style), (_v$, _$p) => {
...
var _el$121 = _tmpl$4();
_$effect(() => _$snapshot(["todo", props.active]), (_v$, _$p) => {
