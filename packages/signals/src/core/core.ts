...
let slotUnobservedHook: ((node: Signal<any>) => void) | null = null;
...
export function runSlotUnobserved(node: Signal<any>): void {
  if (slotUnobservedHook !== null) slotUnobservedHook(node);
}
