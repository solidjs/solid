...
const template = props => {
  ...
  var _v$3 = _$escape(
    ...
    _v$5 = _$escape(
      Child(
        _$mergeProps({ name: "Jason" }, dynamicSpread, {
          ref(r$) {
...
var _v$7 = _$escape(Link({ children: "new" })),
  _v$8 = _$escape(Link({ children: "comments" })),
  _v$9 = _$escape(Link({ children: "show" })),
  _v$10 = _$escape(Link({ children: "ask" })),
  _v$11 = _$escape(Link({ children: "jobs" })),
  _v$12 = _$escape(Link({ children: "submit" }));
const template10 = _$ssr(_tmpl$6, _v$7, _v$8, _v$9, _v$10, _v$11, _v$12);
var _v$13 = _$escape(Link({ children: "new" })),
  _v$14 = _$escape(Link({ children: "comments" })),
  _v$15 = _$escape(Link({ children: "show" })),
  _v$16 = _$escape(Link({ children: "ask" })),
  _v$17 = _$escape(Link({ children: "jobs" })),
  _v$18 = _$escape(Link({ children: "submit" }));
const template11 = _$ssr(_tmpl$7, _v$13, _v$14, _v$15, _v$16, _v$17, _v$18);
var _v$19 = _$escape(Link({ children: "comments" })),
  _v$20 = _$escape(Link({ children: "show" }));
