 ...
 *
 * Truncation (#2958) after the content template parsed, detected before the
 * boundary registers (a deferred entry): the boundary must take the rejected
 * path, not wait for a swap. Separate file because the ledger's truncation
 * record is module state.
 */
...
test("a boundary registering after the cut releases through the rejected path", async () => {
