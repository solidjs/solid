...
_$insert(_el$15, _$createComponent(Link, { children: "new" }), _el$16);
...
_$insert(_el$26, _$createComponent(Link, { children: "new" }), _el$27);
...
class Template29 extends ParentComponent {
	constructor() {
		super();
		const _self$3 = this;
		_$createComponent(this.component, { get method() {
	...
	fieldArrow = () => {
		const _self$8 = this;
		return _$createComponent(this.component, { get method() {
