...
_$effect(() => state.dynamic ? _$createComponent(Comp, {}) : _$createComponent(Comp, {}), (_v$, _$p) => {
...
_$effect(() => state?.dynamic ? "a" : "b", (_v$, _$p) => {
...
_$effect(() => state.dynamic ?? _$createComponent(Comp, {}), (_v$, _$p) => {
