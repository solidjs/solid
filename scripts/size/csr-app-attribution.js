...
import { createSignal, createMemo, lazy, OBSERVE } from "solid-js";
import { attribution, formatRerun } from "solid-js/attribution";

// A records consumer: enable, subscribe on the channel, format — no folds
// (`costs`, `feedback`), which are named exports a production adapter never
// imports.
attribution.enable({ log: false });
OBSERVE.records.subscribe("rerun", e => console.log(formatRerun(e)));
