...
_$insert(_el$, _$createComponent(Ui.Layout.Grid, {
	cols: 2,
	children: "text"
}, "Ui.Layout.Grid"), _el$5);
...
_$insert(_el$, _$createComponent(Comp, { children: () => _$createComponent(Child, {}, "Child") }, "Comp"), _el$9);
const template = (() => {
	const _self$ = this;
	return _el$;
})();
