...
describe("Testing each with indexes", () => {
	...
	test("Create each control flow", () => {
		...
		setList([n1, n2, n3, n4]);
		expect(div.innerHTML).toBe(
			"<span>a0</span><span>b1</span><span>c2</span><span>d3</span>"
		);
		setList([n2, n3, n4, n1]);
		expect(div.innerHTML).toBe(
			"<span>b0</span><span>c1</span><span>d2</span><span>a3</span>"
		);
		setList([n3, n4, n1]);
		expect(div.innerHTML).toBe(
			"<span>c0</span><span>d1</span><span>a2</span>"
		);
		setList([n3, n2, n4, n1]);
		expect(div.innerHTML).toBe(
			"<span>c0</span><span>b1</span><span>d2</span><span>a3</span>"
		);
		setList([]);
		expect(div.innerHTML).toBe("");
	});
