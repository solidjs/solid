...
// runs under `test-types` (tsconfig.test.json); dev-time file, so
// referencing @dom-expressions here is fine (published types never do).
import * as mock from "../src/server-mock.js";
import type * as runtime from "@dom-expressions/runtime/src/server.js";
