...
**R1 — ~~Synchronous universal visibility.~~** ~~An optimistic write is visible to every reader immediately at write time, before any flush.~~ **Superseded 2026-09-10 by A28(5)**: visible at the flush that carries it, to every channel. _Landed 2026-09-15 (read-side A28)._
