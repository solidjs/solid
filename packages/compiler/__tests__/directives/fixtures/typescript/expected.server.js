...
const serverFunction_2 = registerServerReference_1("1db3b5f2-1", function touch(id: string) {
  db.users.touch(id);
});
const touch = createServerReference_1(serverFunction_2);
import { db } from "./db";
const serverFunction_1 = registerServerReference_1("1db3b5f2-0", async (id: string): Promise<unknown> => {
