...
var _tmpl$4 = ["<div", " foo", ' style="', '"', ">", "</div>"];
var _tmpl$5 = ["<div", "", ' class="', '"></div>'];
var _tmpl$6 = ["<div", ' class="a" className="b"></div>'];
var _tmpl$7 = ["<div", ' style="', '">Hi</div>'];
var _tmpl$8 = ["<div", ' style="', '" class="', '"></div>'];
var _tmpl$9 = ["<div", "></div>"];
...
var _tmpl$17 = ["<div", "><input", "", "", " readonly><input", "", "", "", "></div>"];
...
var _tmpl$25 = ["<select", "", "><option", ">Red</option><option", ">Blue</option></select>"];
...
var _tmpl$38 = ["<div", ' a b c d f="0" g h', "", "", " l></div>"];
...
var _tmpl$47 = ["<div", ' style="', '"', "></div>"];
var _tmpl$48 = ["<button", ' type="button"', ' style="', '" class="', '">', "</button>"];
var _tmpl$49 = ["<div", "", "></div>"];
var _tmpl$50 = [
  "<div",
...
var _tmpl$52 = ["<div", "><div>", "</div><div>", '</div><input type="checkbox"', "></div>"];
_$ssrSelectValues();
...
const template19 = _$ssr(
  _tmpl$16,
  _v$23,
  _$ssrClassName([{ "bg-red-500": true }, "flex flex-col"])
);
